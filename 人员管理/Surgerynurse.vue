<template>
  <div
    class="surgery-nurse dashboard-container extVueStyle"
...
export default {
  ...
  methods: {
    ...
    getTabConfing() {
      return {
        id: "surgery-nurse-workload",
        task: "NurseWorkloadDay",
        title: "年度手术护士工作量情况",
        items: [
          { id: "surgery-cases", name: "手术例数", valueField: "ornub" },
          { id: "surgery-duration", name: "手术时长", valueField: "ortime" }
        ],
        desc: [
          "按照每天手术例数或手术情况，将日历中每天的颜色用热度进行展示。",
          "颜色的深浅表明了该日的工作量情况。"
        ]
      };
    },
    ...
    getChartConfigs() {
      ...
      return [
        {
          name: "工作量情况（岗位类型）",
          task: "NurseWorkloadPosttypeMonth",
          id: "surgery-nurse-workload-asa",
          prefix: "surgery",
          type: "singlepie",
          desc: [],
          legendData: [],
        ...
        {
          name: "工作量情况（手术级别）",
          task: "NurseWorkloadSurgeryLevelMonth",
          id: "surgery-nurse-workload-level",
          prefix: "surgery",
          type: "singlepie",
          desc: [],
          legendData: [],
        ...
        },
        {
          ...
          id: "surgery-nurse-workload-surgerydept",
          prefix: "surgery",
          type: "singlepie",
          desc: [],
          legendData: [],
        ...
        {
          name: "手术间安排情况",
          task: "NurseWorkloadRoomMonth",
          id: "surgery-nurse-operating-room-arrange",
          prefix: "surgery",
          type: "singlepie",
          desc: [],
          legendData: [],
        ...
        {
          name: "工作时长情况（上台时长）",
          task: "NurseWorkloadGoupMonth",
          id: "surgery-nurse-workduration-come",
          prefix: "surgery",
          type: "gauge",
