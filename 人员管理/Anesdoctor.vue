<template>
  <div
    class="anes-doctor dashboard-container extVueStyle"
...
export default {
  ...
  methods: {
    ...
    getTabConfing() {
      return {
        id: "anes-doctor-workload",
        task: "SurgetyWorkloadDay",
        title: "年度麻醉医生工作量情况",
        items: [
          { id: "anes-cases", name: "麻醉例数", valueField: "anesnub" },
          { id: "anes-duration", name: "麻醉时长", valueField: "anestime" }
        ],
        desc: [
          "按照每天麻醉例数或麻醉时长情况，将日历中每天的颜色用热度进行展示。",
          "颜色的深浅表明了该日的工作量情况。"
        ]
      };
    },
    ...
    getChartConfigs() {
      ...
      return [
        {
          name: "工作量情况（ASA级别）",
          task: "DoctorWorkloadASAMonth",
          id: "anes-dortor-workload-asa",
          prefix: "anes",
          type: "singlepie",
          desc: [],
          legendData: [],
        ...
        {
          name: "工作量情况（麻醉方法）",
          task: "DoctorWorkloadAnestypeMonth",
          id: "anes-dortor-workload-anestype",
          prefix: "anes",
          type: "singlepie",
          desc: [],
          legendData: [],
        ...
        {
          name: "工作量情况（手术科室）",
          task: "DoctorWorkloadDeptMonth",
          id: "anes-dortor-workload-surgerydept",
          prefix: "anes",
          type: "singlepie",
          desc: [],
          legendData: [],
        ...
        {
          name: "工作量情况（患者年龄段）",
          task: "DoctorWorkloadAgeMonth",
          id: "anes-dortor-workload-age",
          prefix: "anes",
          type: "singlepie",
          desc: [],
          legendData: [],
        ...
        {
          name: "手术间安排情况",
          task: "DoctorWorkloadRoomMonth",
          id: "anes-dortor-operating-room-arrange",
          prefix: "anes",
          type: "singlepie",
          desc: [],
          legendData: [],
        ...
        {
          name: "工作时长情况（上台时长）",
          task: "DoctorWorkloadGoupMonth",
          id: "anes-dortor-workduration-come",
          prefix: "anes",
          type: "gauge",
